...
const Stake = () => {
  ...
  const checkBoxClick = (e, tokenId) => {
    ...
    if (imageDisplay !== "none") {
      ...
      setSelectedNFTs([
        ...selectedNFTs.filter((nft) => nft !== parseInt(token_id)),
      ]);
    } else {
  ...
  const checkBoxClickStaked = (e, tokenId) => {
    ...
    if (imageDisplay !== "none") {
      e.target.querySelector("img").style.display = "none";
      setSelectedStNFTs([
        ...selectedStNFTs.filter((nft) => nft !== parseInt(token_id)),
      ]);
    } else {
      e.target.querySelector("img").style.display = "block";
  ...
  const unStake = async () => {
    try {
      ...
      const estimateGas = await stakingContract.estimateGas._unstakeMany(
        selectedStNFTs
      );
      console.log(estimateGas.toString());
      const tx = {
  ...
  return (
    <>
      ...
      <section className="stake-and-earn-connected wf-section">
        ...
        >
          <div
            data-w-id="002cffd5-e811-2ac9-941c-bdffec8f43b8"
            className="stake-tabs mynfts"
          >
            my nfts
          </div>
          <div
            data-w-id="d91d0851-0831-1435-1930-c2284add1765"
            className="stake-tabs stakes-tab"
          >
            staked
          </div>
        </div>
                ...
                return (
                  <div key={i} className="nft-row">
                    <div
                      ...
                      onClick={(e) => checkBoxClick(e, nft.id.tokenId)}
                    >
                      <img
                        src="images/tick.svg"
              ...
              if (i < stNfts.length - 1) {
                return (
                  <div key={i} className="nft-row">
                    <div
                      className="check-box-holder"
                      onClick={(e) => checkBoxClickStaked(e, nft)}
                    >
                      <img
                        src="images/tick.svg"
                        style={{ pointerEvents: "none", display: "none" }}
      ...
      >
        <div className="stake-period-holder">
          ...
          <div className="button-days-holder">
            <div
              className={classNames("button-nav-small days", {
          ...
          <a
            data-w-id="a320d48d-3cfa-a880-0e58-e1b68e7768dc"
            style={{ opacity: 0 }}
            href="#"
            className="button-unstake w-button"
            onClick={unStake}
          >
            unstake
          </a>
        ...
        <div className="container footer-mobile w-container">
          ...
          <div className="footer-links">
            ...
            <div className="footer-link-holder">
              <a
                href="https://twitter.com/RisingSunCoin"
              ...
              <a
                href="https://instagram.com/RisingSunCoin"
                className="footer-link typo-footer"
              >
                INSTAGRAM
              </a>
              <div className="text-block">-</div>
              <a
                href="https://Facebook.com/RisingSunCoin"
                className="footer-link typo-footer"
              >
                FACEBOOK
              </a>
              <div className="text-block">-</div>
              <a
                href="https://opensea.io/David907"
                className="footer-link typo-footer"
              >
                OPENSEA
              </a>
              ...
              <div className="text-block">-</div>
              <a
                href="https://docs.google.com/forms/d/1wDtI0fs7tfZjWGVoO790_Xk7FiFhDMEGXvW-GqSMhhw/viewform?edit_requested=true"
                className="footer-link typo-footer"
              >
                Refer a friend
              </a>
